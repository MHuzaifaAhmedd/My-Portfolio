  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          className="absolute top-1/4 left-1/4 w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px] bg-gradient-to-br from-primary-500/30 via-primary-600/20 to-transparent rounded-full blur-3xl"
        ...
        />
        <motion.div
          className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px] bg-gradient-to-br from-secondary-500/30 via-secondary-600/20 to-transparent rounded-full blur-3xl"
          style={{ willChange: "transform, opacity" }}
          animate={{
            x: [0, -100, 0],
            y: [0, -60, 0],
        ...
        />
        <motion.div
          className="absolute top-1/2 left-1/2 w-[250px] h-[250px] sm:w-[300px] sm:h-[300px] md:w-[400px] md:h-[400px] bg-gradient-to-br from-luxury-500/20 via-secondary-500/15 to-transparent rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"
          style={{ willChange: "transform, opacity" }}
          animate={{
            scale: [1, 1.3, 1],
            opacity: [0.2, 0.3, 0.2],
      ...
      >
        <motion.div variants={fadeInUp} className="mb-6 sm:mb-8 px-4">
          <motion.span
            className="inline-block px-4 sm:px-6 py-2 sm:py-3 rounded-full glass-strong text-xs sm:text-sm font-medium border border-primary-500/30 tracking-wide"
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-light mb-6 sm:mb-8 leading-[1.1] tracking-tight px-2"
        >
          <span className="block text-foreground/90 mb-2 font-extralight text-3xl sm:text-4xl md:text-5xl lg:text-6xl">Hi, I'm</span>
          <span className="block font-bold gradient-text text-glow break-words">Muhammad Huzaifa Ahmed</span>
        </motion.h1>

        <motion.div
          variants={slideInRight}
          className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-8 sm:mb-10 text-foreground/90 font-light tracking-wide px-4"
        >
          <span className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-full glass-strong border border-primary-500/20 text-sm sm:text-base md:text-lg lg:text-xl">
            ...
            <span className="gradient-text font-medium whitespace-nowrap">Full Stack Developer</span>
          </span>
          ...
          <span className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-full glass-strong border border-secondary-500/20 text-sm sm:text-base md:text-lg lg:text-xl">
            ...
            <span className="gradient-text-gold font-medium whitespace-nowrap">Mobile App Developer</span>
          </span>
        </motion.div>
